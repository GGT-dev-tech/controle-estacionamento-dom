...
import { useTratarSessaoExpirada } from '@/auth/useTratarSessaoExpirada'
import { RequireAdmin } from '@/auth/RequireAdmin'
import { RequireCadastro } from '@/auth/RequireCadastro'
import { iniciarSincronizacaoAutomatica } from '@/offline/sync'
import { SessaoExpiradaToast } from '@/components/SessaoExpiradaToast'
...
export default function App() {
  ...
  return (
    <>
      <SessaoExpiradaToast />
      <RequireCadastro>{rotas}</RequireCadastro>
    </>
  )
}
